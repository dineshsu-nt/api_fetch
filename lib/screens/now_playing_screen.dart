...
final fetchMovie = ApiServices().fetchMovies();
  @override
  void initState() {
    super.initState();
                  ...
                  child: AnimatedContainer(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        contentPadding:  EdgeInsets.symmetric(vertical: 8.0.sp),
        ...
        child: FutureBuilder<List<Movie>>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return  Center(child: CupertinoActivityIndicator(radius: 20.sp,));
